# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2018-10-23 18:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacion', models.TextField(blank=True, max_length=232, null=True)),
                ...
                ('insumoCategoria', models.ManyToManyField(to='Inventarios.InsumoCategoria', verbose_name='InsumoCategoria')),
            ],
        ),
        migrations.CreateModel(
            name='Proveedor',
            fields=[
                ...
                ('Pais', models.CharField(blank=True, max_length=42)),
                ('Region', models.CharField(blank=True, max_length=42)),
                ('ciudad', models.CharField(blank=True, max_length=42)),
                ('direccion', models.CharField(blank=True, max_length=52)),
